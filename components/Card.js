            ...
            <div className="bg-white rounded-md lg:flex shadow-2xl  md:w-auto relative z-30 mx-auto">
                ...
                <div className="lg:hidden p-5 bg-gray-900 rounded ">
                    <div className="w-[56%] mx-auto">
                        <Image src={Profile} objectFit="contain" className="rounded" />
                    </div>
                ...
                <div className="text-center mt-10">
                    ...
                    <button className="bg-black rounded text-white text-xs p-2 mt-8 hover:bg-gray-900 mb-10">Download CV</button>
                </div>
